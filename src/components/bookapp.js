        ...
        <>
            {
                (props.book.read) ?
                    <>
                        <h3>{props.book.title}</h3><br />
                        <h3>{props.book.author}</h3><br />
                        <h3>{props.book.genre}</h3><br />
                        <img src={props.book.image} /> <br />
                        <h3>{props.book.read}</h3><br />
                        <button onClick={(event) => { props.handleNewDelete(props.book) }} >Delete</button>
